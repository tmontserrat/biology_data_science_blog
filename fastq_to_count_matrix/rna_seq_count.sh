...
fastqc data/demo.fastq -o quality/
...
fastqc data/demo_trimmed.fastq -o quality/
...
| samtools sort -o data/demo_trimmed.bam 
...
# Generació del fitxer amb la matriu de contejos
cat quants/demo_featurecounts.txt | cut -f1,7 > quants/count_matrix.txt
